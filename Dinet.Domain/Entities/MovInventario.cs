...
namespace Dinet.Domain.Entities
{
    public class MovInventario
    {
        ...
        public string DocRef1 { get; set; } = string.Empty;
        public string DocRef2 { get; set; } = string.Empty;
        public string DocRef3 { get; set; } = string.Empty;
        public string DocRef4 { get; set; } = string.Empty;
        public string DocRef5 { get; set; } = string.Empty;
